...
import Controller.EmployeeManagamentController;

public class EmployeeManagementImpl implements EmployeeManagamentController {
    ...
    public void addDepartment() {
        ...
        String departmentAddress = scanner.nextLine().trim();
        if (departmentAddress.isEmpty()) {
            System.out.println("Địa chỉ phòng ban không được để trống!");
            return;
        }
    ...
    public void addEmployee() {
        ...
        try {
            ...
            if (employeeId <= 0) {
                System.out.println("Mã nhân viên phải là số dương!");
                return;
            }
        } catch (NumberFormatException e) {
        ...
        try {
            ...
            if (age < 18 || age > 65) {
                System.out.println("Tuổi phải từ 18 đến 65!");
                return;
            }
        } catch (NumberFormatException e) {
        ...
        // Tính lương thực tế và set vào employee
        double calculatedSalary = employee.calculateSalary();
        employee.setSalary(calculatedSalary);
        employees.add(employee);
        System.out.println("Thêm nhân viên thành công!");
        System.out.println("Lương thực tế: " + String.format("%,.0f", calculatedSalary) + " VNĐ");
    }
    ...
    public void updateEmployee() {
        ...
        String newDepartmentId = scanner.nextLine().trim();
        ...
        // Tính lại lương thực tế
        double newCalculatedSalary = employee.calculateSalary();
        employee.setSalary(newCalculatedSalary);
        
        System.out.println("Cập nhật nhân viên thành công!");
        System.out.println("Lương thực tế mới: " + String.format("%,.0f", newCalculatedSalary) + " VNĐ");
    }
    ...
    public void deleteEmployee() {
        ...
        System.out.println("Bạn có chắc chắn muốn xóa nhân viên: " + employee.getName() + "? (y/n)");
